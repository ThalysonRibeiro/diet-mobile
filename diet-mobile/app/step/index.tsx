...
const schema = z.object({
  name: z.string().min(1, { message: "O nome é obrogatório" }),
  weight: z.string().min(1, { message: "O peso é obrogatório" }),
  age: z.string().min(1, { message: "A idade é obrogatório" }),
  height: z.string().min(1, { message: "A altura é obrogatório" }),
});

...
import Select from "@/components/imput/select";
import { userDataStore } from "../../store/data";
import { router } from "expo-router";
const schema = z.object({
  gender: z.string().min(1, { message: "O sexo é obrogatório" }),
  objective: z.string().min(1, { message: "O objetivo é obrogatório" }),
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <Select
          control={control}
          name="gender"
          placeholder="Seleciopne seu sexo..."
        ...
        <Select
          control={control}
          name="level"
          placeholder="Seleciopne seu nivel de atividade física"
        ...
        <Select
          control={control}
          name="objective"
          placeholder="Seleciopne seu objetivo"
